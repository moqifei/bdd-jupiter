 ...
 * @description: 调用示例 <br>
 *     String carName =
 *     ChineseCharacterHelper.getSpells(String.valueOf(user.getName().charAt(0))).toUpperCase();<br>
 */
public class ChineseCharacterHelper {
  ...
  private static final int[] secPosValueList = {
    1601, 1637, 1833, 2078, 2274, 2302, 2433, 2594, 2787, 3106, 3212, 3472, 3635, 3722, 3730, 3858,
